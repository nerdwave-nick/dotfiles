...
require('nerdwave.themeing')(config)
require('nerdwave.signals')
...
awful.keyboard.append_global_keybindings({
  awful.key({ config.modifier }, 'Left', awful.tag.viewprev, { description = 'view previous', group = 'tag' }),
  awful.key({ config.modifier }, 'Right', awful.tag.viewnext, { description = 'view next', group = 'tag' }),
  awful.key({ config.modifier }, 'Escape', awful.tag.history.restore, { description = 'go back', group = 'tag' }),
})
...
awful.keyboard.append_global_keybindings({
  ...
  awful.key({ config.modifier }, 'Tab', function()
  ...
  awful.key({ config.modifier, 'Control' }, 'n', function()
...
awful.keyboard.append_global_keybindings({
  ...
  awful.key({
    modifiers = { config.modifier, 'Control' },
    keygroup = 'numrow',
  ...
  awful.key({
    modifiers = { config.modifier, 'Shift' },
    keygroup = 'numrow',
  ...
  awful.key({
    modifiers = { config.modifier, 'Control', 'Shift' },
    keygroup = 'numrow',
...
client.connect_signal('request::default_keybindings', function()
  awful.keyboard.append_client_keybindings({
    ...
    awful.key({ config.modifier, 'Shift' }, 'c', function(c) c:kill() end, { description = 'close', group = 'client' }),
    awful.key(
      { config.modifier, 'Control' },
      'space',
    ...
    awful.key({ config.modifier }, 'n', function(c)
      -- The client currently has the input focus, so it cannot be
      -- minimized, since minimized clients can't have the focus.
      c.minimized = true
    end, { description = 'minimize', group = 'client' }),
    awful.key({ config.modifier }, 'm', function(c)
      c.maximized = not c.maximized
      c:raise()
    end, { description = '(un)maximize', group = 'client' }),
    awful.key({ config.modifier, 'Control' }, 'm', function(c)
      c.maximized_vertical = not c.maximized_vertical
      c:raise()
    end, { description = '(un)maximize vertically', group = 'client' }),
    awful.key({ config.modifier, 'Shift' }, 'm', function(c)
...
require('nerdwave.config')
require('nerdwave.rules')
require('nerdwave.autostart')
